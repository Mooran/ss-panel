...
<style>
    .login-box-body {
        box-shadow: 0px 4px 18px #d6d6d6;
...
<div class="login-box">
  <!--   <div class="login-logo">
    ...
    <div class="login-box-body">
        <h3 class="login-box-msg" style="border-bottom: 1px solid #dadada;margin-bottom: 12px;">登录到用户中心</h3>
        <form>
...
<script>
    ...
    $(function () {
        ...
        // $('.login-box-msg').animateCss('bounce');
    });
...
<script>
    $(document).ready(function(){
        ...
        $("#login").click(function(){
            login();
            // $('.login-box').animateCss('rotateOutDownLeft');
        });
